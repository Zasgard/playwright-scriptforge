...
def record(url, output, browser, headless):
    ...
    """
    click.echo(f"🎬 Recording Playwright session...")
    ...
    try:
        ...
        click.echo("❌ Playwright not found. Ensure it's installed: pip install playwright", err=True)
        sys.exit(1)
...
def convert(python_file, output):
    ...
    """
    click.echo(f"🔄 Converting Python to YAML...")
    ...
    try:
        ...
        click.echo(f"✅ YAML script saved to: {output}")
        click.echo(f"\nParameters found:")
...
def compile(yaml_file, output, param):
    ...
    """
    click.echo(f"⚙️  Compiling YAML to Python...")
    ...
    try:
        ...
        click.echo(f"✅ Python script saved to: {output}")
...
def validate(yaml_file):
    ...
    """
    click.echo(f"🔍 Validating YAML script...")
